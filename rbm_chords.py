...
songs = get_songs('Pop_Music_Midi') #msgpack
...
#hyper parameters
num_timesteps  = 16 #This is the number of timesteps that we will create at a time
...
with tf.Session() as sess:
    ...
    sample = gibbs_sample(1).eval(session = sess, feed_dict = {x: np.zeros((8, n_visible))})
